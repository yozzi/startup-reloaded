...
<div class="login row" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'login' ); ?>" method="post" role="form">
