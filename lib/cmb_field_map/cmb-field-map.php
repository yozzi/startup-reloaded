...
class PW_CMB2_Field_Google_Maps {
	...
	public function setup_admin_scripts() {
        ...
        wp_enqueue_script( 'pw-google-maps', get_template_directory_uri() . '/lib/cmb_field_map/js/script.js', array( 'pw-google-maps-api' ), self::VERSION );
		wp_enqueue_style( 'pw-google-maps', get_template_directory_uri() . '/lib/cmb_field_map/css/style.css', array(), self::VERSION );
