...
class OWN_Field_Slider {
	...
	public function setup_admin_scripts( ) {
		...
		wp_enqueue_script( 'cmb2_field_slider_js',  get_template_directory_uri() . '/lib/cmb2-field-slider/js/cmb2_field_slider.js', array( 'jquery', 'jquery-ui-slider' ), self::VERSION );

		wp_register_style( 'slider_ui', 'http://code.jquery.com/ui/1.11.3/themes/smoothness/jquery-ui.css', array(), '1.0' );
		wp_enqueue_style( 'cmb2_field_slider_css', get_template_directory_uri() . '/lib/cmb2-field-slider/css/cmb2_field_slider.css', array( 'slider_ui' ), self::VERSION );
