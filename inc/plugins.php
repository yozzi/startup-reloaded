...
function startup_reloaded_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'notice_can_activate_required'    => _n_noop( 'Le plugin requis suivant est actuellement désactivé: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'tgmpa'),
            'notice_can_activate_recommended' => _n_noop( 'Le plugin recommandé suivant est actuellement désactivé: %1$s.', 'The following recommended plugins are currently inactive: %1$s.', 'tgmpa'),
